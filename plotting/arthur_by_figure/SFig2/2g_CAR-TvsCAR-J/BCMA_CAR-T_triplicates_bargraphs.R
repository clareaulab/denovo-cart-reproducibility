...
fread("../data/BCMA_CAR-T_CD69_triplicates.tsv") %>% data.frame() %>%
  tidyr::pivot_longer(
...
p1 <- ready_df %>%
  ...
  scale_fill_manual(values = c("black", "#ff0000", "#a9a9a9")) + 
  theme(legend.position = "none")
p1
cowplot::ggsave2(p1, file = "../plots/BCMA_pBCMA_parental_CD69_CAR-T_triplicates.pdf", width = 4.5, height = 1.6)
...
t_test_go("K562.Parental", "m971", "4434")
