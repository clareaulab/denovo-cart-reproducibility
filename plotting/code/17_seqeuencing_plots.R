...
cd19_e3_m2f_plot <- plot_fc(cd19_e3_tpm,"CD19_parental_mean","CD19_M2F_mean")
...
cowplot::ggsave2(cd19_e3_m2f_plot, file = "../plots/tpm_FC_cd19_m2f_1000nM.pdf", width = 1.3, height = 1.3)
